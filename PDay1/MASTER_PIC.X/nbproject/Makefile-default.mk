...
FINAL_IMAGE=dist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=source/interrupts.c source/main.c source/messages.c source/Motor_thread.c source/my_i2c.c source/my_uart.c source/Parser_thread.c source/timer0_thread.c source/timer1_thread.c source/uart_thread.c source/user_interrupts.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/source/interrupts.p1 ${OBJECTDIR}/source/main.p1 ${OBJECTDIR}/source/messages.p1 ${OBJECTDIR}/source/Motor_thread.p1 ${OBJECTDIR}/source/my_i2c.p1 ${OBJECTDIR}/source/my_uart.p1 ${OBJECTDIR}/source/Parser_thread.p1 ${OBJECTDIR}/source/timer0_thread.p1 ${OBJECTDIR}/source/timer1_thread.p1 ${OBJECTDIR}/source/uart_thread.p1 ${OBJECTDIR}/source/user_interrupts.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/source/interrupts.p1.d ${OBJECTDIR}/source/main.p1.d ${OBJECTDIR}/source/messages.p1.d ${OBJECTDIR}/source/Motor_thread.p1.d ${OBJECTDIR}/source/my_i2c.p1.d ${OBJECTDIR}/source/my_uart.p1.d ${OBJECTDIR}/source/Parser_thread.p1.d ${OBJECTDIR}/source/timer0_thread.p1.d ${OBJECTDIR}/source/timer1_thread.p1.d ${OBJECTDIR}/source/uart_thread.p1.d ${OBJECTDIR}/source/user_interrupts.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/source/interrupts.p1 ${OBJECTDIR}/source/main.p1 ${OBJECTDIR}/source/messages.p1 ${OBJECTDIR}/source/Motor_thread.p1 ${OBJECTDIR}/source/my_i2c.p1 ${OBJECTDIR}/source/my_uart.p1 ${OBJECTDIR}/source/Parser_thread.p1 ${OBJECTDIR}/source/timer0_thread.p1 ${OBJECTDIR}/source/timer1_thread.p1 ${OBJECTDIR}/source/uart_thread.p1 ${OBJECTDIR}/source/user_interrupts.p1

# Source Files
SOURCEFILES=source/interrupts.c source/main.c source/messages.c source/Motor_thread.c source/my_i2c.c source/my_uart.c source/Parser_thread.c source/timer0_thread.c source/timer1_thread.c source/uart_thread.c source/user_interrupts.c
...
.build-conf:  ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-default.mk dist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
...
${OBJECTDIR}/source/Motor_thread.p1: source/Motor_thread.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/Motor_thread.p1.d 
	@${RM} ${OBJECTDIR}/source/Motor_thread.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/source/Motor_thread.p1  source/Motor_thread.c 
	@-${MV} ${OBJECTDIR}/source/Motor_thread.d ${OBJECTDIR}/source/Motor_thread.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/source/Motor_thread.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
${OBJECTDIR}/source/uart_thread.p1: source/uart_thread.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/uart_thread.p1.d 
	@${RM} ${OBJECTDIR}/source/uart_thread.p1 
	${MP_CC} --pass1 $(MP_EXTRA_CC_PRE) --chip=$(MP_PROCESSOR_OPTION) -Q -G  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"    -o${OBJECTDIR}/source/uart_thread.p1  source/uart_thread.c 
	@-${MV} ${OBJECTDIR}/source/uart_thread.d ${OBJECTDIR}/source/uart_thread.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/source/uart_thread.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.map  -D__DEBUG=1 --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"        -odist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=default,+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=0 --asmlist --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     -odist/${CND_CONF}/${IMAGE_TYPE}/MASTER_PIC.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}     
