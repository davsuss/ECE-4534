...
enum {GET_MSG_ID_AND_LEN,
GET_SAMPLE, GET_DISTANCE_FEET_LEFT, GET_DISTANCE_INCHES_LEFT,
GET_DISTANCE_FEET_RIGHT, GET_DISTANCE_INCHES_RIGHT, GET_CHECK_SUM};

unsigned char STATE = GET_MSG_ID_AND_LEN;
unsigned char MSG_LEN = 0;
unsigned char MSG_REC = 0;
