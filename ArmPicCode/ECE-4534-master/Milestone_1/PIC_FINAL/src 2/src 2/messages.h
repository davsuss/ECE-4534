...
// Each element in the queue has a message that
// contains a buffer
// MSGLEN is the size of that buffer
#define MSGLEN 22
...
// Queue:
// The "ToMainLow" queue is a message queue from low priority
// interrupt handlers to the "main()" thread. This message
signed char ToMainLow_sendmsg_pointer(unsigned char, unsigned char, void *);
signed char ToMainLow_recvmsg_pointer(unsigned char, unsigned char*, void *);
